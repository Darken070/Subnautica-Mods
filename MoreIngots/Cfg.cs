    ...
    public class Cfg
    {
        ...
        public static void Load()
        {
            try
            {
                ...
                | Config.TryGet(ref _yMIDiamond, "Compressed Diamond", "Size", "y")
                ...
                | Config.TryGet(ref _xMIMagnetite, "Compressed Magnetite", "Size", "x")
                | Config.TryGet(ref _yMIMagnetite, "Compressed Magnetite", "Size", "y")
                | Config.TryGet(ref _xMINickel, "Nickel Ingot", "Size", "x")
                | Config.TryGet(ref _yMINickel, "Nickel Ingot", "Size", "y")
                | Config.TryGet(ref _xMIKyanite, "Compressed Kyanite", "Size", "x")
                | Config.TryGet(ref _yMIKyanite, "Compressed Kyanite", "Size", "y")
                | Config.TryGet(ref _xMIRuby, "Compressed Ruby", "Size", "x")
                | Config.TryGet(ref _yMIRuby, "Compressed Ruby", "Size", "y")
                | Config.TryGet(ref _xMIUraninite, "Uraninite Ingot", "Size", "x")
                | Config.TryGet(ref _yMIUraninite, "Uraninite Ingot", "Size", "y")
                | Config.TryGet(ref _xMIQuartz, "Compressed Quartz", "Size", "x")
                | Config.TryGet(ref _yMIQuartz, "Compressed Quartz", "Size", "y")
                ...
                | Config.TryGet(ref _aMIDiamond, "Compressed Diamond", "Craft amount")
                ...
                | Config.TryGet(ref _aMIMagnetite, "Compressed Magnetite", "Craft amount")
                | Config.TryGet(ref _aMINickel, "Nickel Ingot", "Craft amount")
                | Config.TryGet(ref _aMIKyanite, "Compressed Kyanite", "Craft amount")
                | Config.TryGet(ref _aMIRuby, "Compressed Ruby", "Craft amount")
                | Config.TryGet(ref _aMIUraninite, "Uraninite Ingot", "Craft amount")
                | Config.TryGet(ref _aMIQuartz, "Compressed Quartz", "Craft amount")
                | Config.TryGet(ref _aMISalt, "Salt Lick", "Craft amount")

                | Config.TryGet(ref _eMIGold, "Gold Ingot", "Enabled")
                | Config.TryGet(ref _eMIDiamond, "Compressed Diamond", "Enabled")
                ...
                | Config.TryGet(ref _eMIMagnetite, "Compressed Magnetite", "Enabled")
                | Config.TryGet(ref _eMINickel, "Nickel Ingot", "Enabled")
                | Config.TryGet(ref _eMIKyanite, "Compressed Kyanite", "Enabled")
                | Config.TryGet(ref _eMIRuby, "Compressed Ruby", "Enabled")
                | Config.TryGet(ref _eMIUraninite, "Uraninite Ingot", "Enabled")
                | Config.TryGet(ref _eMIQuartz, "Compressed Quartz", "Enabled")
