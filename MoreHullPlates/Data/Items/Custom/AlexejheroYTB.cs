...
namespace MoreHullPlates.Items
{
    public partial class Load
    {
        public partial class Custom
        {
            ...
            private static UnityEngine.Sprite sprite = AssetBundle.LoadFromFile($@"./QMods/MoreHullPlates/Assets/icon.assets").LoadAsset<UnityEngine.Sprite>("bikemanhullplate");
