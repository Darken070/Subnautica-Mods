...
namespace MoreIngots
{
    public class QPatch
    {
        ...
        public static void Patch()
        {
            ...
            var techTypeMIGold = TechTypePatcher.AddTechType("MIGold", "Gold Ingot", "Au. Condensed gold. To turn it back into gold, enter this command in the debug console: \"unlock gold\". Added by MoreIngots mod. ");
            var techTypeMIDiamond = TechTypePatcher.AddTechType("MIDiamond", "Graphite", "C. Condensed diamond. To turn it back into diamond, enter this command in the debug console: \"unlock diamond\". Added by MoreIngots mod");
            var techTypeMILithium = TechTypePatcher.AddTechType("MILithium", "Lithium Bar", "Li. Condensed lithium. To turn it back into lithium, enter this command in the debug console: \"unlock lithium\". Added by MoreIngots mod");
            var techTypeMICopper = TechTypePatcher.AddTechType("MICopper", "Copper Ingot", "Cu. Condensed copper. To turn it back into copper, enter this command in the debug console: \"unlock copper\". Added by MoreIngots mod");
            var techTypeMILead = TechTypePatcher.AddTechType("MILead", "Lead Bar", "Pb. Condensed lead. To turn it back into lead, enter this command in the debug console: \"unlock lead\". Added by MoreIngots mod");
            var techTypeMISilver = TechTypePatcher.AddTechType("MISilver", "Silver Ingot", "Ag. Condensed silver. To turn it back into silver, enter this command in the debug console: \"unlock silver\". Added by MoreIngots mod");
            var techTypeMIMagnetite = TechTypePatcher.AddTechType("MIMagnetite", "Maghemite", "γ-Fe2O3. Condensed magnetite. To turn it back into magnetite, enter this command in the debug console: \"unlock magnetite\". Added by MoreIngots mod");
            var techTypeMINickel = TechTypePatcher.AddTechType("MINickel", "Nickel Sheets", "Ni. Condensed nickel. To turn it back into nickel, enter this command in the debug console: \"unlock nickel\". Added by MoreIngots mod");
            var techTypeMIKyanite = TechTypePatcher.AddTechType("MIKyanite", "Topaz", "Al2(F,OH)2SiO4. Condensed kyanite. To turn it back into kyanite, enter this command in the debug console: \"unlock kyanite\". Added by MoreIngots mod");
            var techTypeMIRuby = TechTypePatcher.AddTechType("MIRuby", "Bauxite", "Al(OH)3. Condensed ruby. To turn it back into ruby, enter this command in the debug console: \"unlock aluminiumoxide\". Added by MoreIngots mod");
            var techTypeMIUraninite = TechTypePatcher.AddTechType("MIUraninite", "Triuranium octoxide", "U3O8. Condensed uraninite. To turn it back into uraninite, enter this command in the debug console: \"unlock uraninitecrystal\". Added by MoreIngots mod");
            var techTypeMIQuartz = TechTypePatcher.AddTechType("MIQuartz", "Silicate", "SiO4. Condensed quartz. To turn it back into quartz, enter this command in the debug console: \"unlock quartz\". Added by MoreIngots mod");
...
new IngredientHelper(techTypeMIQuartz, 1)
            ...
            CraftTreePatcher.customCraftNodes.Add("Resources/AdvancedMaterials/MIDiamond", techTypeMIDiamond);
            CraftTreePatcher.customCraftNodes.Add("Resources/BasicMaterials/Diamond", TechType.Diamond);
            ...
            CraftTreePatcher.customCraftNodes.Add("Resources/AdvancedMaterials/MIKyanite", techTypeMIKyanite);
            CraftTreePatcher.customCraftNodes.Add("Resources/BasicMaterials/Kyanite", TechType.Kyanite);
            ...
            CraftTreePatcher.customCraftNodes.Add("Resources/AdvancedMaterials/MIRuby", techTypeMIRuby);
            CraftTreePatcher.customCraftNodes.Add("Resources/BasicMaterials/AluminumOxide", TechType.AluminumOxide);
