...
namespace MoreIngots
{
    public class QPatch
    {
        ...
        public static void Patch()
        {
            ...
            Logger.Debug("Loading asset bundles... (4/4)");
            Logger.Debug("Asset bundles loaded");

            Logger.Debug("Loading config...");
            Config.Load();
            Logger.Debug("Config loaded");

            Logger.Debug("Obtaining config data...");
            var configChanged =
            ...
            Logger.Debug("Config data obtained");

            Logger.Debug("Checking config for errors... (0/82)");
            ...
            Logger.Debug("Checking config for errors... (10/82)");
            if (_yMIDiamond <= 0)
            {
                _yMIDiamond = 1;
            ...
            Logger.Debug("Checking config for errors... (20/82)");
            if (_xMILead <= 0)
            {
                _xMILead = 1;
            ...
            Logger.Debug("Checking config for errors... (30/82)");
            if (_yMIMagnetite <= 0)
            {
                _yMIMagnetite = 1;
            ...
            Logger.Debug("Checking config for errors... (40/82)");
            if (_xMIRuby <= 0)
            {
                _xMIRuby = 1;
            ...
            Logger.Debug("Checking config for errors... (50/82)");
            if (_yMIQuartz <= 0)
            {
                _yMIQuartz = 1;
            ...
            Logger.Debug("Checking config for errors... (60/82)");
            if (_aMILithium <= 0)
            {
                _aMILithium = 10;
            ...
            Logger.Debug("Checking config for errors... (70/82)");
            if (_aMINickel <= 0)
            {
                _aMINickel = 10;
            ...
            Logger.Debug("Checking config for errors... (80/82)");
            if (_aMISalt <= 0)
            {
                _aMISalt = 10;
            ...
            Logger.Debug("Checking config for errors... (82/82)");
            if (configChanged)
            {
                Logger.Debug("Error check complete. Some errors found and fixed");
            ...
            {
                Logger.Debug("Error check complete. No errors found");
            }

            Logger.Debug("Loading TechTypes... (0/13)");
            ...
            Logger.Debug("Loading TechTypes... (5/13)");
            ...
            Logger.Debug("Loading TechTypes... (10/13)");
            ...
            Logger.Debug("Loading TechTypes... (13/13)");
            Logger.Debug("TechTypes loaded");

            Logger.Debug("Loading TechDatas... (0/26)");
            ...
            Logger.Debug("Loading TechDatas... (5/26)");
            ...
            Logger.Debug("Loading TechDatas... (10/26)");
            ...
            Logger.Debug("Loading TechDatas... (15/26)");
            ...
            Logger.Debug("Loading TechDatas... (20/26)");
            ...
            Logger.Debug("Loading TechDatas... (25/26)");
            ...
            Logger.Debug("Loading TechDatas... (26/26)");
            Logger.Debug("TechDatas loaded");

            Logger.Debug("Loading sprites... (0/15)");
            ...
            Logger.Debug("Loading sprites... (5/15)");
            ...
            Logger.Debug("Loading sprites... (10/15)");
            ...
            Logger.Debug("Loading sprites... (14/15)");
            ...
            Logger.Debug("Loading sprites... (15/15)");
            Logger.Debug("Sprites loaded");

            Logger.Debug("Loading alternative sprites... (0/15)");
            ...
            Logger.Debug("Loading alternative sprites... (5/15)");
            ...
            Logger.Debug("Loading alternative sprites... (10/15)");
            ...
            Logger.Debug("Loading alternative sprites... (15/15)");
            Logger.Debug("Alternative sprites loaded");

            if (_alttextures == true)
            {
                Logger.Info("Alternative textures is true");
                Logger.Debug("Applying alternative sprites... (0/13)");
                ...
                Logger.Debug("Applying alternative sprites... (5/13)");
                ...
                Logger.Debug("Applying alternative sprites... (10/13)");
                ...
                Logger.Debug("Applying alternative sprites... (13/13)");
                Logger.Debug("Alernative sprites applied");
                Logger.Debug("Loading fabricator tabs with alternative sprites... (0/2)");
                ...
                Logger.Debug("Loading fabricator tabs with alternative sprites... (1/2)");
                ...
                Logger.Debug("Loading fabricator tabs with alternative sprites... (2/2)");
                Logger.Debug("Fabricator tabs with alternative sprites loaded");
            }
            else
            {
                Logger.Info("Alternative textures is false");
                Logger.Debug("Applying sprites... (0/13)");
                ...
                Logger.Debug("Applying sprites... (5/13)");
                ...
                Logger.Debug("Applying sprites... (10/13)");
                ...
                Logger.Debug("Applying sprites... (12/13)");
                CustomSpriteHandler.customSprites.Add(new CustomSprite(techTypeMISalt, SpriteSaltAlex));
                ...
                Logger.Debug("Applying sprites... (13/13)");
                Logger.Debug("Sprites applied");
                Logger.Debug("Loading fabricator tabs... (0/2)");
                ...
                Logger.Debug("Loading fabricator tabs... (1/2)");
                ...
                Logger.Debug("Loading fabricator tabs... (2/2)");
                Logger.Debug("Fabricator tabs loaded");
            }

            Logger.Debug("Adding TechTypes to the PDA Databank... (0/26)");
            ...
            Logger.Debug("Adding TechTypes to the PDA Databank... (5/26)");
            ...
            Logger.Debug("Adding TechTypes to the PDA Databank... (10/26)");
            ...
            Logger.Debug("Adding TechTypes to the PDA Databank... (15/26)");
            ...
            Logger.Debug("Adding TechTypes to the PDA Databank... (20/26)");
            ...
            Logger.Debug("Adding TechTypes to the PDA Databank... (25/26)");
            CraftDataPatcher.AddToCustomGroup(TechGroup.Resources, TechCategory.BasicMaterials, TechType.Salt);
            Logger.Debug("Adding TechTypes to the PDA Databank... (26/26)");
            Logger.Debug("TechTypes added to the PDA Databank");

            Logger.Debug("Linking recipes... (0/26)");
            ...
            Logger.Debug("Linking recipes... (5/26)");
            ...
            Logger.Debug("Linking recipes... (10/26)");
            ...
            Logger.Debug("Linking recipes... (15/26)");
            ...
            Logger.Debug("Linking recipes... (20/26)");
            ...
            Logger.Debug("Linking recipes... (25/26)");
            CraftDataPatcher.customTechData.Add(TechType.Salt, techDataMISaltB);
            Logger.Debug("Linking recipes... (26/26)");
            Logger.Debug("Recipes linked");

            Logger.Debug("Adding fabricator nodes... (0/26)");
            ...
            Logger.Debug("Adding fabricator nodes... (5/26)");
            ...
            Logger.Debug("Adding fabricator nodes... (10/26)");
            ...
            Logger.Debug("Adding fabricator nodes... (15/26)");
            ...
            Logger.Debug("Adding fabricator nodes... (20/26)");
            ...
            Logger.Debug("Adding fabricator nodes... (25/26)");
            CraftTreePatcher.customNodes.Add(new CustomCraftNode(TechType.Salt, CraftScheme.Fabricator, "Resources/Unpack/Salt"));
            Logger.Debug("Adding fabricator nodes... (26/26)");
            Logger.Debug("Fabricator nodes added");

            Logger.Debug("Setting custom item sizes... (0/14)");
            ...
            Logger.Debug("Setting custom item sizes... (5/14)");
            ...
            Logger.Debug("Setting custom item sizes... (10/14)");
            ...
            Logger.Debug("Setting custom item sizes... (14/14)");
            Logger.Debug("Custom item sizes set");
